...
public class ItemTests
{
    ...
    public void Cannot_Create_Rating_With_Invalid_Name(){
        var item = new Item(null!, "Description", "Brand", 10.00m);
    }

    [TestMethod]
    [ExpectedException(typeof(ArgumentNullException))]
    public void Cannot_Create_Rating_With_Invalid_Description(){
        var item = new Item("Name", null!, "Brand", 10.00m);
    }

    [TestMethod]
    [ExpectedException(typeof(ArgumentNullException))]
    public void Cannot_Create_Rating_With_Invalid_Brand(){
